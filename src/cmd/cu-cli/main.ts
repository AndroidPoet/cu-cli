...
import { defaultRuntime, runCommandWithRuntime } from "../../internal/cli/runtime.js";
import { theme, formatHelpExamples, formatDocsLink } from "../../internal/cli/theme.js";
  ...
  .addHelpText(
    ...
    () =>
      `\n${theme.heading("Examples:")}\n${formatHelpExamples([
        ["cu-cli auth", "Configure ClickUp API token"],
        ["cu-cli workspaces", "List workspaces"],
        ["cu-cli lists --space-id <id>", "List lists in a space"],
        ["cu-cli tasks list --list-id <id>", "List tasks in a list"],
        ["cu-cli tasks create --list-id <id> --name \"New Task\"", "Create a task"],
...
const auth = program.command("auth").description("Configure ClickUp API token");
...
auth
  ...
  .action(async (token: string) => {
    await runClickUpCommand(async () => {
      const { clickUpAuthSetCommand } = await import("./commands/auth-set.js");
...
auth
  ...
  .action(async () => {
    await runClickUpCommand(async () => {
      const { clickUpAuthStatusCommand } = await import("./commands/auth-status.js");
...
program
  ...
  .action(async (opts) => {
    await runClickUpCommand(async () => {
      const { clickUpWorkspacesCommand } = await import("./commands/workspaces.js");
...
program
  ...
  .action(async (opts) => {
    await runClickUpCommand(async () => {
      const { clickUpSpacesCommand } = await import("./commands/spaces.js");
...
program
  ...
  .action(async (opts) => {
    await runClickUpCommand(async () => {
      const { clickUpFoldersCommand } = await import("./commands/folders.js");
...
program
  ...
  .action(async (opts) => {
    await runClickUpCommand(async () => {
      const { clickUpListsCommand } = await import("./commands/lists.js");
...
tasks
  ...
  .action(async (opts) => {
    await runClickUpCommand(async () => {
      const { clickUpTasksListCommand } = await import("./commands/tasks-list.js");
...
tasks
  ...
  .action(async (taskId: string, opts) => {
    await runClickUpCommand(async () => {
      const { clickUpTaskGetCommand } = await import("./commands/task-get.js");
...
tasks
  ...
  .action(async (opts) => {
    await runClickUpCommand(async () => {
      const { clickUpTaskCreateCommand } = await import("./commands/task-create.js");
...
tasks
  ...
  .action(async (taskId: string, opts) => {
    await runClickUpCommand(async () => {
      const { clickUpTaskUpdateCommand } = await import("./commands/task-update.js");
...
tasks
  ...
  .action(async (taskId: string, opts) => {
    await runClickUpCommand(async () => {
      const { clickUpTaskDeleteCommand } = await import("./commands/task-delete.js");
